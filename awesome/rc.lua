...
--awful.util.tagnames = {  " ", " ", " ", " ", " ", " ", " ", " ", " ", "  " }
awful.util.tagnames = { " DEV ", " WWW ", " SYS ", " DOC ", " VMs ", " CHAT ", " MLT ", " GFX ", " GAME " }
...
local myawesomemenu = {
    ...
    { "edit config", terminal.." vim /home/maksymilian/.config/awesome/rc.lua" },
    { "arandr", "arandr" },
...
globalkeys = my_table.join(
    ...
    awful.key({ modkey, altkey }, "b", function () awful.util.spawn( "brave" ) end,
        {description = "brave browser" , group = "CMOON CMOON IS SHE?" }),
   ...
   -- awful.key({ modkey, altkey }, "e", function () awful.util.spawn( "emacsclient -a 'emacs' -c" ) end,
    ...
    --awful.key({ modkey, altkey }, "l", function () awful.util.spawn( terminal.." brave " ) end,
    --    {description = "brave browser" , group = "CMOON CMOON IS SHE?" }),
    ...
    -- Personal keybindings}}}
    awful.key({ modkey, altkey,    }, "[", function() awful.util.spawn ( "lutris" ) end,
     {description = "lutris", group = "game"}),
    awful.key({ modkey,        }, "p", function() awful.util.spawn ( "gimp" ) end,
     {description = "gimp", group = "gfx"}),
    awful.key({modkey, altkey, "Control"}, "d", function() awful.util.spawn ( terminal.." -e cordless" ) end,
     {description = "cordless", group = "chat"}),
   ...
   -- awful.key({ modkey }, "Right", function () lain.util.tag_view_nonempty(1) end,
    ...
    awful.key({ modkey,           }, "Return", function () awful.spawn( terminal ) end,
              {description = "aw piss of", group = "super"}),
    ...
    awful.key({ altkey, "Shift"   }, "l",     function () awful.tag.incmwfact( 0.05)          end,
              {description = "width to left", group = "layout"}),
    awful.key({ altkey, "Shift"   }, "j",     function () awful.tag.incmwfact(-0.05)          end,
              {description = "width to right", group = "layout"}),
    awful.key({ modkey, "Shift"   }, "j",     function () awful.tag.incnmaster( 1, nil, true) end,
              {description = "swap windows around /right", group = "layout"}),
    awful.key({ modkey, "Shift"   }, "l",     function () awful.tag.incnmaster(-1, nil, true) end,
              {description = "swap windows around /left", group = "layout"}),
    awful.key({ modkey, "Control" }, "j",     function () awful.tag.incncol( 1, nil, true)    end,
              {description = "more clients for right", group = "layout"}),
    awful.key({ modkey, "Control" }, "l",     function () awful.tag.incncol(-1, nil, true)    end,
              {description = "more clients for left", group = "layout"}),
...
clientkeys = my_table.join(
    ...
    awful.key({ altkey,         }, "F4",      function (c) c:kill()                         end,
              {description = "close", group = "Window Mngmnt"}),
    awful.key({ modkey, "Shift" }, "f",  awful.client.floating.toggle                     ,
              {description = "toggle floating", group = "Window Mngmnt"}),
    awful.key({ modkey, "Control" }, "Return", function (c) c:swap(awful.client.getmaster()) end,
              {description = "move to master", group = "Window Mngmnt"}),
    awful.key({ modkey,           }, "o",      function (c) c:move_to_screen()               end,
              {description = "move to screen", group = "Window Mngmnt"}),
    awful.key({ modkey,           }, "t",      function (c) c.ontop = not c.ontop            end,
              {description = "toggle keep on top", group = "Window Mngmnt"}),
    awful.key({ modkey,           }, "n",
        function (c)
